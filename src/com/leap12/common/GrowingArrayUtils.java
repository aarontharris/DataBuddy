...
public final class GrowingArrayUtils {
	...
	public static int[] append( int[] array, int currentSize, int element ) {
		...
		if ( currentSize + 1 > array.length ) {
			int[] newArray = (int[]) Array.newInstance( array.getClass().getComponentType(), growSize( currentSize ) );
	...
	public static long[] append( long[] array, int currentSize, long element ) {
		...
		if ( currentSize + 1 > array.length ) {
			long[] newArray = (long[]) Array.newInstance( array.getClass().getComponentType(), growSize( currentSize ) );
	...
	public static boolean[] append( boolean[] array, int currentSize, boolean element ) {
		...
		if ( currentSize + 1 > array.length ) {
			...
			boolean[] newArray = (boolean[]) Array.newInstance( array.getClass().getComponentType(), growSize( currentSize ) );
			System.arraycopy( array, 0, newArray, 0, currentSize );
			array = newArray;
		}
		array[currentSize] = element;
