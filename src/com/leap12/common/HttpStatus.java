...
public interface HttpStatus {
	...
	/**
	 * Static constant for a 418 error. <tt>418 Unprocessable Entity</tt> (WebDAV drafts?)
	...
	/**
	 * Static constant for a 419 error. <tt>419 Insufficient Space on Resource</tt> (WebDAV - draft-ietf-webdav-protocol-05?)
	 * or <tt>419 Proxy Reauthentication Required</tt> (HTTP/1.1 drafts?)
	 */
